...
**Branch**: `001-docling-pdf2md-stack` | **Date**: 2026-08-18, revised 2026-08-19 | **Spec**: [spec.md](./spec.md)
...
**Primary Dependencies**: `docling-serve-cpu` (upstream container image, pinned by tag and digest, arm64, models baked in); FastAPI; `httpx`; `python-multipart`; stdlib `sqlite3`. Delivery depends on GitHub for the stack definition and GHCR for both images, at deploy time only
